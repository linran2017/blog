                        ...
                        <ul class="list-group menus">
                            <li class="list-group-item" id="3">
                                ...
                                <a href="{{u('modules/modules/lists')}}"
                                   class="quickMenuLink">模块管理</a>
                            </li>
                    </ul>
                    <if value="$installedModules">
                        <div class="panel-heading">
                            <h4 class="panel-title">扩展模块</h4>
                            <a class="panel-collapse" data-toggle="collapse" href="javascript:;">
                                <i class="fa fa-chevron-circle-down"></i>
                            </a>
                        </div>
                        <ul class="list-group menus">
                            <foreach from="$installedModules" value="$v">
                                <li class="list-group-item" id="3">

                                    <a href="?m={{$v['name']}}&a=controller/entry/index"
                                       class="quickMenuLink">{{$v['title']}}</a>
                                </li>
                            </foreach>
                        </ul>
                        <else/>
